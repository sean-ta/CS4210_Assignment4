...
#-------------------------------------------------------------------------
# AUTHOR: Sean Ta
# FILENAME: SeanTa_deeplearning
# SPECIFICATION: Assignment #4 Question #4
...
highestAccuracy = 0  # set highestAccuracy to 0 first
for h in n_hidden:                          #looking or the best parameters w.r.t the number of hidden layers
    for n in n_neurons:                     #looking or the best parameters w.r.t the number of neurons
        for l in l_rate:                    #looking or the best parameters w.r.t the learning rate
            ...
            prediction_list.append(class_predicted==y_test) # append number of true predictions 
            #-->add your Pyhton code here
            
            accuracy = sum(prediction_list[0])/len(prediction_list[0]) # find accuracy by adding number of true predictions divided by number of predictions
