...
#-------------------------------------------------------------------------
# AUTHOR: Sean Ta
# FILENAME: SeanTa_perceptron
# SPECIFICATION: Assingment #4 Question 2 - perceptron
...
highest_accuracy_p = 0 # set perceptron highest accuracy to 0
highest_accuracy_m = 0 # set mlp highest accuracy to 0
for w in n: #iterates over n
    ...
    for b in r: #iterates over r
        ...
        for a in range(2): #iterates over the algorithms
            ...
            #--> add your Python code here
                accuracy = sum(prediction_list)/len(prediction_list) # calculate perceptron accuracy
            
            if a == 0: # model is perceptron
                if accuracy > highest_accuracy_p: # if accuracy is higher than highest accuracy
                    highest_accuracy_p = accuracy # set highest accuracy to accuracy
                    print("Highest Perceptron accuracy so far: {}, Paramaters: learning rate={}, shuffle={}".format(highest_accuracy_p[0],w,b))
            if a == 1: # if model is MLP
                if accuracy > highest_accuracy_m: # if accuracy is higher than highest accuracy
                    highest_accuracy_m = accuracy # set highest accuracy to accuracy
                    print("Highest MLP accuracy so far: {}, Paramaters: learning rate={}, shuffle={}".format(highest_accuracy_m[0],w,b))
